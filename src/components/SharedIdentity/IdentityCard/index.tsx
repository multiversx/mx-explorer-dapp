        ...
        <div className="row">
                ...
                <div className="d-flex mt-3 align-items-center flex-wrap">
                  {identity.location && (
                    <div className="d-flex align-items-center me-3">
                      <FontAwesomeIcon icon={faMapMarkerAlt} className="text-secondary me-1" />
                  ...
                  {identity.website && (
                    <div className="d-flex align-items-center me-1">
                      <FontAwesomeIcon icon={faLink} className="text-secondary me-1" />
          ...
          <div className="col-12 col-lg-5 d-flex flex-column flex-sm-row ps-lg-0">
            <div className="d-flex flex-column flex-fill mt-4 mt-lg-0">
              ...
              <div className="d-flex mt-2">
                <span className="text-secondary pe-2">Computed APR:</span>
