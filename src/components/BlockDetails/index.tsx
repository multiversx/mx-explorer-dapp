...
const BlockDetails = () => {
  ...
  const invalid = !blockId || (blockId && !isHash(blockId));
                ...
                <div className="card-body p-0">
                  <div className="container-fluid">
                    ...
                    {block.shardId === metaChainShardId && (
                      <>
                        <div className="row py-3 border-bottom">
                          <div className="col-lg-2 text-light text-lg-right">Notarized Blocks</div>
                          <div className="col">
                    ...
                    <div className="row py-3 border-bottom">
                      <div className="col-lg-2 text-light text-lg-right">Public Keys Bitmap</div>
