...
describe('Search input', () => {
  test('Search finds block', async () => {
    ...
    const data = {
      target: {
        value:
          'c51471d4b6a439af44c51bff7372c4f02a8c98ba3bf81e7e080fe461c074d1c1'
      }
    };
  ...
  test('Search finds transaction', async () => {
    ...
    const data = {
      target: {
        value:
          '41fa1461ac134ee095dbee60c3cc2848255181aaa2bdd6f5aae386d58e0d4a80'
      }
    };
    fireEvent.change(search, data);
  ...
  test('Search finds node', async () => {
    ...
    await wait(async () => {
      expect(document.title).toEqual(
        'Node Details • MultiversX (previously Elrond) Explorer'
      );
    });
  });
