...
const TokenDetailsCard = () => {
  ...
  return identifier !== '' ? (
    <>
      <Helmet>
        <title>{`${title} • MultiversX (Elrond) Explorer`}</title>
        {assets && assets.description && <meta name="description" content={assets.description} />}

        <meta name="twitter:title" content={`${title} • MultiversX (Elrond) Explorer`} />
        ...
        <meta property="og:title" content={`${title} • MultiversX (Elrond) Explorer`} />
        {assets && assets.description && (
