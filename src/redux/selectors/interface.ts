...
export const interfaceSelector = createSelector(stateSelector, (state) => state);
...
export const activeThemeSelector = createSelector(stateSelector, (state) => state.activeTheme);
...
export const refreshSelector = createSelector(stateSelector, (state) => state.refresh);
