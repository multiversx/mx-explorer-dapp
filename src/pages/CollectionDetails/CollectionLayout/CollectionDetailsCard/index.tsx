          ...
          <div className="card">
            ...
            <div className="card-body p-0">
              <div className="container-fluid">
                ...
                {decimals !== undefined && <DetailItem title="Decimals">{decimals}</DetailItem>}
                <DetailItem title="Properties">
                  <div className="d-flex alig-items-center flex-wrap">
                    ...
                    <PropertyPill name={'Can Add Special Roles'} active={canAddSpecialRoles} />
                    <PropertyPill name={'Can Transfer'} active={Boolean(canTransfer)} />
                  </div>
                </DetailItem>
